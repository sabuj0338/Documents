...
├── auth/ (permissions.ts, guards.ts, Can.tsx)
└── constants/index.ts
```
...
Identical to the enterprise guide: `routing.ts`, `request.ts`, `navigation.ts`, and `messages/en.json`.
...
## 15. Dashboard Layout Components
